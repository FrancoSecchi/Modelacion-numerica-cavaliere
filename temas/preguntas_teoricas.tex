...
Un ejemplo es el método de Newton-Raphson. La idea es que una vez que estamos cerca de la solución, cada iteración del método reduce el error de manera significativa, haciendo que el método sea muy eficiente.
